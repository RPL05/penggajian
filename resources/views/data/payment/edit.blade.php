    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-6">
        ...
        <div class="card border-0 shadow">
          <div class="card-body">
            <form action="{{ route('data.payment.update', $payments->id) }}" enctype="multipart/form-data" method="post">
                @csrf
                @if(session('success'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="no_rek" id="no_rek" value="{{ $payments->no_rek }}" class="form-control" required>
                            <span class="text-danger" id="no_rek"></span>
                        </div>
                        <div class="form-group">
                            <label for="tgl_transfer">Tanggal Transfer</label>
                            <input type="date" name="tgl_transfer" id="tgl_transfer" value="{{ $payments->tgl_transfer }}" class="form-control" required>
